...
const PROVIDERS = [
  { id: '9ab972fc-8aca-4c35-93f5-d1ede32e32b9', name: 'Instagram User Info' },
  { id: 'binance-kyc-status-provider', name: 'Binance KYC Status (ZK)' },
  { id: 'joseph-binance', name: 'Joseph Binance (key-update)' },
  { id: 'binance-kyc-full-disclosure', name: 'Binance KYC (Full Disclosure)' },
